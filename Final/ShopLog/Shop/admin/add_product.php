...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Handle the form.
	...
	if (empty($errors)) { // If everything's OK.
            ...
            $inv = new Inventory();
            $dbc = $inv->getDB();
            $inv->add_prod($dept, $pn, $p, $d, $i, $temp, $dbc);
...
<form enctype="multipart/form-data" action="add_product.php" method="post">
	...
	<p>Fill out the form to add a product to the catalog:</p>
	...
	<p><b>Image:</b> <input type="file" name="img" /></p>
        ...
        <p><b>Department:</b>
	<select name="dept"><option>Select a Department</option>
