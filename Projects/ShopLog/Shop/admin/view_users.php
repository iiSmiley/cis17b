...
// Define the query:
$q = "SELECT last_name, first_name, DATE_FORMAT(registration_date, '%M %d, %Y') AS dr, user_id, user_level AS ul From entity_user ORDER BY  $order_by LIMIT $start, $display";		
