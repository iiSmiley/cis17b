...
while ($row = mysqli_fetch_array ($r, MYSQLI_ASSOC)) {
	...
	// Display each record:
	echo "\t<tr>
		<td align=\"left\"><a href=\"../user/user_browse_products.php?did={$row['dept_id']}\">{$row['dept_name']}</a></td>
		<td align=\"left\"><a href=\"../user/user_view_product.php?pid={$row['prod_id']}\">{$row['prod_name']}</a></td>
