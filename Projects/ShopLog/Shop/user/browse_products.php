...
while ($row = mysqli_fetch_array ($r, MYSQLI_ASSOC)) {
	...
	// Display each record:
	echo "\t<tr>
                <td align=\"left\"><a href=\"../admin/edit_product.php?id={$row['prod_id']}\">Edit</a></td>
                <td align=\"left\"><a href=\"../admin/delete_product.php?id={$row['prod_id']}\">Delete</a></td>
		<td align=\"left\"><a href=\"../admin/browse_products.php?did={$row['dept_id']}\">{$row['dept_name']}</a></td>
		<td align=\"left\"><a href=\"../admin/view_product.php?pid={$row['prod_id']}\">{$row['prod_name']}</a></td>
