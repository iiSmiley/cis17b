...
--
-- Table structure for table `entity_order_content`
--

DROP TABLE IF EXISTS `entity_order_content`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `entity_order_content` (
  `oc_id` mediumint(7) NOT NULL,
  `order_id` mediumint(7) DEFAULT NULL,
  `product_id` mediumint(7) DEFAULT NULL,
...
--
-- Dumping data for table `entity_order_content`
--

LOCK TABLES `entity_order_content` WRITE;
/*!40000 ALTER TABLE `entity_order_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `entity_order_content` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `entity_prod` VALUES (1,1,'Coffee Arabica',9.99,'Dope','coffee.jpg'),(4,2,'Mocha',2.99,'Yummy','coffee.jpg');
...
INSERT INTO `order_contents` VALUES (1,1,2,3,9.99,NULL);
...
INSERT INTO `orders` VALUES (1,1,178.93,'2019-12-07 11:23:47');
...
-- Dump completed on 2019-12-08  3:37:55
